...
$GLOBALS['TL_LANG']['tl_child_category']['copy']  		 	= array('Copy record', 'Copy record ID %s');
$GLOBALS['TL_LANG']['tl_child_category']['delete'] 			= array('Delete record', 'Delete record ID %s');
$GLOBALS['TL_LANG']['tl_child_category']['toggle'] 			= array('Toggle record', 'Toggle record ID %s');
